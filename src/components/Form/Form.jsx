...
export default function Form() {
    ...
    return (
        <>
            <div className="bg-formBackground pb-[60px] px-0 w-full">
                <h4 className="m-0 font-sans font-semibold  text-xl text-mainTextColor">
                    {t('headerText')}
                    <br />
                    {t('headerTextSecoundPart')}
                </h4>
                <div>
                    <form onSubmit={handleSubmit(onSubmit)} className="bg-white w-full space-y-4">
                            ...
                            <button
                                ...
                                className={clsx(
                                    'w-fit font-normal leading-[1.4] text-[22px] pt-[11px] px-[45px] pb-[15px] rounded-full transition-colors',
                                    {
                                        ...
                                        'bg-gradient-to-r from-gradientInputStart to-gradientInputFinish text-white cursor-pointer': isValid
                                    }
                                )}
                            >
                                {t('nextPage')}
            ...
            <div className="pb-1">
                <p className="text-center font-bold text-lg text-mainTextColor">{t('formFooterInfo')}</p>
