...
export default function Form() {
    ...
    const handleSubmitForm = async (data) => {
        try {
            const response = await fetch('/sendMailFormToManager.php', {
                method: 'POST',
                headers: {
                    ...
                    {step === 2 && (
                        <form onSubmit={handleSubmit(onSubmit)} className=" w-full space-y-4">
                                ...
                                {selectedTherapeuticArea && (
                                    <>
                                        ...
                                        <div className="flex flex-col space-y-1 w-full col-span-full">
                                            ...
                                            />
                                            {errors.question && <p className="text-red-500 text-sm mt-1 pl-5">{errors.question.message}</p>}
                                        </div>
                                    </>
                                )}
                            </div>
                            ...
                            <div className="flex flex-col space-y-4 p-6 rounded">
                                ...
                                {/* Question 2 */}
                                <div className="flex flex-col">
                                    <label className="text-mainTextColor font-medium text-[12px] uppercase mb-2">{t('pregnancy')} *</label>
                                    <div className="flex space-x-6">
                                        <Controller
                                            name="pregnancy"
                                            control={control}
