...
const resources = {
    ru: {
        translation: {
            ...
            iAgreePersonl: 'Даю согласие на обработку',
            iAgreePerson2: 'персональных данных',
            ...
            footerRightsReserved: '© 2024, ТОО "Такеда Казахстан". Все права защищены.',
    ...
    kz: {
        translation: {
            ...
            iAgreePersonl: 'Жеке деректерді өңдеуге',
            iAgreePerson2: 'келісім беремін',
            ...
            footerRightsReserved: '© 2024, "Такеда Казахстан" ЖШС. Барлық құқықтар қорғалған.',
